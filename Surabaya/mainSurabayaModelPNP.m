%% Model PNP Surabaya per Kebijakan:
...
k{1}.name = 'Kebijakan Istilah Baru'; 
k{1}.startDate = '2020-08-04';
...
% lockdown.startDate = '2021-05-20'; %50%
lockdown.startDate = '2021-08-03'; %75%
...
if(softwareName == 'matlab')
    gabung = getDataModelPNP('COVID19_Surabaya.xls'); %[EDITABLE Matlab]
else
    gabung = getDataModelPNP('COVID19_Surabaya.csv'); %[EDITABLE Octave]
end
...
% custom states
customStates = {'P','D'}; % [EDITABLE] Ubah nama state sesuai yang ingin di-plot. Pisahkan dengan koma ','.
