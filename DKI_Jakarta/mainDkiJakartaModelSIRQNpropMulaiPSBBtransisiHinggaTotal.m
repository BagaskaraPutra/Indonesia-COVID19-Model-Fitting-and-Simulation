%% SIRQNprop DKI Jakarta per Kebijakan:
...
fullscreen = [0 0 1 1]; figureSize = [0 0 0.69 0.8787]; % custom figure size
...
% custom states
customStates = {'ND','I','Q','D'}; % [EDITABLE] Ubah nama state sesuai yang ingin di-plot. Pisahkan dengan koma ','.
