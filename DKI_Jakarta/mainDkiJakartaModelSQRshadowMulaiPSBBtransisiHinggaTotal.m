...
keteranganSimulasi = ['RateBasedMulaiFit' datestr(k{1}.timeFit{1},'yyyy-mm-dd') ...
...
%     k{i}.ubParam(find(strcmp(model.paramName, 'beta'))) = 2.0;
%     k{i}.ubParam(find(strcmp(model.paramName, 'Rt'))) = 5.0; %6.0;
%     k{i}.ubParam(find(strcmp(model.paramName, 'Tinf'))) = 10;
%     k{i}.ubParam(find(strcmp(model.paramName, 'Trecov'))) = 50;
%     k{i}.ubParam(find(strcmp(model.paramName, 'Tdeath'))) = 41; %60; %100; 
%     k{i}.ubParam(find(strcmp(model.paramName, 'lambda'))) = 2.0;
end
% If you want to manually set parameter: 
...
k{1}.y0(find(strcmp(model.allStateName, 'R_s'))) = k{1}.y0(find(strcmp(model.allStateName, 'Q')));
...
k{lockdown.index}.paramEst(find(strcmp(model.paramName, 'Rt'))) = 0; % namun nilai beta di-set nol
