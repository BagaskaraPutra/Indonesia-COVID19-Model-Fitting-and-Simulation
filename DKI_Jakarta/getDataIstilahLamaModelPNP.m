function k = getDataIstilahLamaModelPNP(fileName)
    global softwareName;
    ...
    k.NI = ODPproses + PDPdirawat;
    k.NR = ODPselesai + PDPsembuh;
    k.P = PositifPerawatan + PositifIsolasiMandiri;
    k.R = Sembuh;
    k.ND = ODPmeninggal + PDPmeninggal;
